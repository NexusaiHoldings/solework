...
-- Golf editions: complete the men's size run (7-13).
INSERT INTO shoe_skus (silhouette_id, colorway_id, us_size, name, stock_quantity, price_cents, is_active) VALUES
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f1', 7, 'Golf — The General M7', 6, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f1', 8, 'Golf — The General M8', 8, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f1', 12, 'Golf — The General M12', 8, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f1', 13, 'Golf — The General M13', 6, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f2', 7, 'Golf — Freak M7', 6, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f2', 8, 'Golf — Freak M8', 8, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f2', 12, 'Golf — Freak M12', 8, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f2', 13, 'Golf — Freak M13', 6, 18900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f3', 7, 'Golf — JJ M7', 6, 19900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f3', 8, 'Golf — JJ M8', 8, 19900, true),
  ('a0000001-0000-0000-0000-0000000000f1','b0000001-0000-0000-0000-0000000000f3', 12, 'Golf — JJ M12', 8, 19900, true),
